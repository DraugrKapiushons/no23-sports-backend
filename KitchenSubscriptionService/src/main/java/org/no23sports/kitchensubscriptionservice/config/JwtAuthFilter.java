package org.no23sports.kitchensubscriptionservice.config;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (path.startsWith("/kitchen/subscriptions/swagger-ui") ||
            path.startsWith("/kitchen/subscriptions/v3/api-docs") ||
            path.startsWith("/kitchen/subscriptions/webjars")) {
